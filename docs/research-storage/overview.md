...
[home folders](overview.md#home-folders), [scratch folders](overview.md#scratch-storage),
and [project spaces.](overview.md#project-spaces)
...
see our page on [working with spaces, folders, and files](working-with-spaces-files-and-folders.md).
...
spaces are backed up every evening. If you should need to recover any
files due to accidental deletion or corruption, please
[contact RCS](mailto:research@hbs.edu).
...
files, and data loss may result. As with home folders, project spaces
that reach capacity are not a good thing. Please see our [working with
spaces, folder, &
files](working-with-spaces-files-and-folders.md) page
for useful tips. 
